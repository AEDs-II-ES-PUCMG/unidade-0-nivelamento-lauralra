...
public class Produto {
    ...
    /**
     * Construtor completo. Os valores default, em caso de erro, são: "Produto
     * sem descrição", R$ 0.00, 0.0
     *
     * @param desc Descrição do produto (mínimo de 3 caracteres)
     * @param precoCusto Preço do produto (mínimo 0.01)
    ...
    /**
     * Construtor sem margem de lucro - fica considerado o valor padrão de
     * margem de lucro. Os valores default, em caso de erro, são: "Produto sem
     * descrição", R$ 0.00
     *
     * @param desc Descrição do produto (mínimo de 3 caracteres)
     * @param precoCusto Preço do produto (mínimo 0.01)
    ...
    /**
     * Descrição, em string, do produto, contendo sua descrição e o valor de
     * venda.
     *
